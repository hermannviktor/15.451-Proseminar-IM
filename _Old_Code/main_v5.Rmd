...
```{r setup, include=FALSE}
library(readxl)
filepath_ellie = "/Users/EllieLiu/Desktop/Monthly_returns.xlsx" #'/Users/hermannviktor/Python/PycharmProjects/15.451-Proseminar-IM/Excel/data.xlsx'
#filepath_haocheng = "Desktop/MIT/Fall2018/Proseminar/data/clean data/data.xlsx"
dt1 <- read_excel(filepath_ellie)
View(dt1)
...
SORR_to_coverage = function(path_equity,path_FI,a,start_point=0,end_point=0,e,x,n,m) {
  withdraw = matrix(0,nrow = 1, ncol = n)
...
results_hist = SORR_to_coverage_dist(path_equity = path_equity,path_FI = path_FI, a=0.6,e=100000,x=0.04,n=342,m=100000)
