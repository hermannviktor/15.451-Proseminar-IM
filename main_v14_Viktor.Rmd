...
######## Run this whole portion together for it to work ######
...
legend(1,
       7,
       c('SORR 0.1','SORR 0.2','SORR 0.3','SORR 0.4','SORR 0.5','SORR 0.6','SORR 0.7','SORR 0.8','SORR 0.9','SORR 1.0'),
       lty=1:10,
       cex=0.8,
       col = c('black', 'red', 'green', 'blue', 'turquoise', 'pink', 'yellow', 'lightblue', 'black', 'red'))
##############################################################
